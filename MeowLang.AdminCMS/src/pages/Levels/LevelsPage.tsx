...
function LevelsPage() {
  ...
  const handleStartEdit = (level: Level) => {
    ...
    setEditDisplayName(level.displayName);
    setEditSortOrder(level.sortOrder);
  };
  ...
  const handleSaveEdit = async (id: number) => {
    ...
    try {
      setIsSaving(true);
      const updated = await levelsApi.update(parseInt(languageId), id, {
      ...
      <Header
        ...
        action={
          <div className={styles.headerActions}>
            ...
            />
            <Button label="+ Add Level" onClick={() => setIsAdding(true)} />
          </div>
        }
      />
                      ...
                      <div className={styles.editRow}>
                        ...
                        <div className={styles.editActions}>
                          <Button
                            ...
                            disabled={isSaving || !editDisplayName}
                          />
                          <Button
                            label="Cancel"
                            variant="secondary"
                    ...
                    <td className={styles.td}>
                      <div className={styles.actions}>
                        ...
                        <Button
                          ...
                          variant="danger"
                          onClick={() =>
                            handleDelete(level.id, level.displayName)
                          }
                        />
                      </div>
                    </td>
